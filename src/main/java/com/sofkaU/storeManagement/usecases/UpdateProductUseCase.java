...
@Service
@AllArgsConstructor
public class UpdateProductUseCase implements Function<ProductDto, Mono<ProductDto>> {
    ...
    public Mono<ProductDto> apply(ProductDto productDto) {
        return productRepository
                ...
                .flatMap(product -> productRepository.save(productMapper.convertDtoToEntity().apply(productDto)))
