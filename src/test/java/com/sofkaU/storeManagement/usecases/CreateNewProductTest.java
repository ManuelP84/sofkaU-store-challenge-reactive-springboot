...
public class CreateNewProductTest {
    ...
    void createNewProduct(){
        ...
        Mockito.when(productRepository.save(productTest)).thenReturn(Mono.just(productTest));

        Mono<ProductDto> monoProduct = createProductUseCase.apply(productMapper.convertEntityToDto().apply(productTest));
